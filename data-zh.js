const DATA_ZH = `#### Build your own \`Distributed Systems\` - 分布式系统
...
#### Build your own \`3D Renderer\` - 3D 渲染器
...
#### Build your own \`Augmented Reality\` - 增强现实
...
#### Build your own \`BitTorrent Client\` - BT 客户端
...
#### Build your own \`Blockchain / Cryptocurrency\` - 区块链与加密货币
...
#### Build your own \`Command-Line Tool\` - 命令行工具
...
#### Build your own \`Emulator / Virtual Machine\` - 模拟器与虚拟机
...
#### Build your own \`Front-end Framework / Library\` - 前端框架与库
...
#### Build your own \`Neural Network\` - 神经网络
...
#### Build your own \`Operating System\` - 操作系统
...
#### Build your own \`Physics Engine\` - 物理引擎
...
#### Build your own \`Programming Language\` - 编程语言
...
#### Build your own \`Regex Engine\` - 正则引擎
...
#### Build your own \`Search Engine\` - 搜索引擎
...
#### Build your own \`Template Engine\` - 模板引擎
...
#### Build your own \`Text Editor\` - 文本编辑器
...
#### Build your own \`Visual Recognition System\` - 视觉识别系统
...
#### Build your own \`Web Server\` - Web 服务器
...
* [**(any)**: _build-your-own-x-vibe-coding: BYOX-style tutorials adapted for vibe coding_](https://github.com/inFaaa/build-your-own-x-vibe-coding)
...
## Contribute - 贡献指南
* 欢迎提交 PR，或[创建 Issue](https://github.com/codecrafters-io/build-your-own-x/issues/new)
* 通过评论和"reactions"帮助我们审核[待处理的提交](https://github.com/codecrafters-io/build-your-own-x/issues)

## Origins & License - 起源与许可

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

本仓库是[众多贡献者](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors)的共同成果。由 [Daniel Stefanovic](https://github.com/danistefanovic) 发起，现由 [CodeCrafters, Inc.](https://codecrafters.io) 维护。在法律允许的范围内，[CodeCrafters, Inc.](https://codecrafters.io) 已放弃本作品的所有版权及相关权利。
`;
